...
class MainApp(MDApp):
    def __init__(self, **kwargs):
        ...
        menu_items = [{"viewclass": "IconListItem",
                       ...
                       "height": dp(36),
                       "text": "soft_1@mail.ru",
                       "on_release": lambda x="soft_1@mail.ru": self.set_item(x), },
                      {"viewclass": "IconListItem",
                       "icon": "email",
                       "height": dp(36),
                       "text": "soft_2@mail.ru",
                       "on_release": lambda x="soft_2@mail.ru": self.set_item(x), },
                      {"viewclass": "IconListItem",
                       "icon": "email",
                       "height": dp(36),
                       "text": "soft_3@mail.ru",
                       "on_release": lambda x="soft_3@mail.ru": self.set_item(x), }
                      ]
